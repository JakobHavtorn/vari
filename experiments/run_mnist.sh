...
# env CUDA_VISIBLE_DEVICES='3' python experiments/main_mnist.py --name "OOD MNISTBinarized HVAE [5, 2] EXCL=[4] IW=10 WU=0 BS=256" with 'n_epochs=1000' 'exclude_labels=[4]' 'warmup_epochs=0' 'dataset_name=MNISTBinarized' 'vae_type=HierarchicalVariationalAutoencoder'
...
# env CUDA_VISIBLE_DEVICES='3' python experiments/main_mnist.py --name "OOD FashionMNISTBinarized HVAE [5, 2] EXCL=[0] IW=10 WU=0 BS=256" with 'n_epochs=1000' 'exclude_labels=[0]' 'warmup_epochs=0' 'dataset_name=FashionMNISTBinarized' 'vae_type=HierarchicalVariationalAutoencoder'
...
# env CUDA_VISIBLE_DEVICES='3' python experiments/main_mnist.py --name "OOD MNISTBinarized HVAE [5, 2] EXCL=[8] IW=10 WU=0 BS=256" with 'n_epochs=1000' 'exclude_labels=[8]' 'warmup_epochs=0' 'dataset_name=MNISTBinarized' 'vae_type=HierarchicalVariationalAutoencoder'
...
# env CUDA_VISIBLE_DEVICES='3' python experiments/main_mnist.py --name "OOD FashionMNISTBinarized HVAE [5, 2] EXCL=[8] IW=10 WU=0 BS=256" with 'n_epochs=1000' 'exclude_labels=[8]' 'warmup_epochs=0' 'dataset_name=FashionMNISTBinarized' 'vae_type=HierarchicalVariationalAutoencoder'
