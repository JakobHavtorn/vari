...
env CUDA_VISIBLE_DEVICES='4' python experiments/main_synthetic2d.py \
...
# SPIRALS
env CUDA_VISIBLE_DEVICES='3' python experiments/main_synthetic2d.py \
--name "OOD Spirals σ=0.00 VAE z=[2] h=[[64, 64, 32, 32, 16, 16]] IW=1 WU=1000 BS=256 E=30000" with \
'n_epochs=30000' \
'batch_size=256' \
...
env CUDA_VISIBLE_DEVICES='3' python experiments/main_synthetic2d.py \
--name "OOD Spirals σ=0.00 VAE z=[2,2,2] h=[[64, 64], [32, 32], [16, 16]] IW=1 WU=1000 BS=256 E=30000" with \
'n_epochs=30000' \
'batch_size=256' \
'dataset_name=Spirals' \
'dataset_kwargs.noise=0.00' \
